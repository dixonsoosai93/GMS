        ...
        <div class="vz_main_content">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card_title text-right">ADD RHR Redressal Authority </h4>
                            <form id="RhrInvestigator" action="CreateRhrInvestigatorMaster" method="post">
	                             <div class="form-group">
								   <label class="col-form-label" for="REGION_CODE">Region Name</label>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <input type="text" name="REGION_ID" class="form-control" id="REGION_ID" disabled>
	                            </div>			                      
	                            <div class="form-group">
