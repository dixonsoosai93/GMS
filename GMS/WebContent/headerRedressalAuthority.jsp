	...
	<header class="vz_main_header flex-grow-1 top_nav">
        <div class="container-fluid d-flex flex-row h-100 align-items-center">
            <div class="text-center rt_nav_wrapper d-flex align-items-center">
                <a class="nav_logo rt_logo" href="DailyDairyUpdationList.jsp"><img src="images/tata-aia-logo.png" alt="logo"/></a>
                <a class="nav_logo nav_logo_mob" href="DailyDairyUpdationList.jsp"><img src="images/tata-aia-logo.png" alt="logo"/></a>
            </div>
