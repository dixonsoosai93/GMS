        ...
        <div class="vz_main_content">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card_title text-right">ADD ZLGC Redressal Authority</h4>
                            <form id="ZlgcInvestigator" action="CreateZlgcInvestigatorMaster" method="post">
                            
	                             <div class="form-group">
								   <label class="col-form-label" for="ZONE_CODE">Zone Name</label>
									<select class="js-select2 form-control" name="ZONE_CODE" id="ZONE_CODE" aria-hidden="true">
	                            ...
	                            <div class="form-group">
	                                <label class="col-form-label" for="ZONE_ID">Zone ID</label>
	                                <input type="text" name="ZONE_ID" class="form-control" id="ZONE_ID" disabled>
	                            </div>			                      
	                             <div class="form-group">
	                                ...
	                                <select class="js-select2 form-control" name="INVESTIGATOR_EMPLOYEE_ID" id="INVESTIGATOR_EMPLOYEE_ID" aria-hidden="true">
										<option disabled selected>Choose Employee Name</option>
										<%
										int i=1;
