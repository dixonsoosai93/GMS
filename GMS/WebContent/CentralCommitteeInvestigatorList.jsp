                ...
                <div class="col-12">
                   	<div class="card">
	                       ...
	                       <div class = "heading__prdu mb-1">
                           		<h4 class="card_title text-center text-uppercase mb-0">Central Committee Redressal Authority</h4>
                            </div>
	                       <div class="btnPosi">
                            	<div class="rightpageBtn">
                            		<a style="position: relative;" href="#" id="addCentralInv">
										<span title="" data-toggle="popover" data-trigger="hover" data-content="Add Central Committee Investigator">
                           ...
                           <div class="table-responsive datatable-primary">
								<table style="width:100%;"  id="dataTable2" class="text-center">
                                      <thead class="text-uppercase">
                                        <tr>
                                           	<th>S.No.</th>
                                            <th>CC Redressal Authority ID</th>
                                      ...
                                      <%
                                        int i=1;
                                        List<CentralCommitteeInvestigatorModel> list= CentralCommitteeInvestigatorDAO.centralInvMaster();
                                        if(list !=null){
                                        	for(CentralCommitteeInvestigatorModel item :list){
                                        %>
		                                <tr>
		                                  <td><%=i%></td>
		                                  <td><%=item.getCENTRALID()%></td>
		                                  <td><%=item.getNAME()%></td>
		                                  ...
		                                  <td>
		                                      <ul class="d-flex justify-content-center">
												 <li class="mr-3"><button type="button" class="btn btn-inverse-secondary edit" keys="<%=item.getCENTRALID()%>"><i class="fa fa-edit"></i></button></li> 
		                                      </ul>
		                                  </td>
										</tr>
										<%
...
<script type="text/javascript">
 document.getElementById("addCentralInv").onclick = function(){
 location.href ="CentralCommitteeInvestigator.jsp";
 };
 $(function() {
...
<script>
 ...
 $('.edit').click(function(){
 var CENTRALID= $(this).attr('keys');
 location.href ="EditCentralCommitteeInvestigator.jsp?CENTRALID="+CENTRALID; 
 });
</script>
</body>
</html>
