	...
	<header class="vz_main_header flex-grow-1 top_nav">
        <div class="container-fluid d-flex flex-row h-100 align-items-center">
            <div class="text-center rt_nav_wrapper d-flex align-items-center">
                <a class="nav_logo rt_logo" href="EmployeeGLP.jsp"><img src="images/tata-aia-logo.png" alt="logo"/></a>
                <a class="nav_logo nav_logo_mob" href="EmployeeGLP.jsp"><img src="images/tata-aia-logo.png" alt="logo"/></a>
            </div>
...
<!--                         </div> -->
                    ...
                    <li class="nav-item d_none_sm">
                        <a class="nav-link logout_link" href="EmployeeGrievanceLogout">
