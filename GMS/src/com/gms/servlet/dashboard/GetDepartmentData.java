...
@WebServlet("/GetDepartmentData")
public class GetDepartmentData extends HttpServlet {
	static Logger logger = Logger.getLogger(GetDepartmentData.class.getName()); 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ParseException {
        ...
        try {
        	if(days != 0) {
        		JSONArray jArray = Graph.getDepartment(days);
        	...
        	ex.printStackTrace();
        	ex.getMessage();
        	logger.info("Inside the processRequest() method Exception : "+ ex.getMessage());
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			Logger.getLogger(GetDepartmentData.class.getName());
		}
	}
