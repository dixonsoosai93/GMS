...
/**
 * Servlet implementation class GetZoneData
 */
@WebServlet("/GetZoneData")
public class GetZoneData extends HttpServlet {
	static Logger logger = Logger.getLogger(GetZoneData.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ParseException {
        ...
        try {
        	if(days != 0) {
        		JSONArray jArray = Graph.getZone(days);
