...
@WebServlet("/GetStatusData")
public class GetStatusData extends HttpServlet {
	static Logger logger = Logger.getLogger(GetStatusData.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ParseException {
        ...
        try {
        	if(days != 0) {
        		JSONArray jArray = Graph.getStatus(days);
